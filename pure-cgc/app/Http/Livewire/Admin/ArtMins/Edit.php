...
{
    use WithFileUploads;
    public $ord,$type,$category_id,$name,$name_en,$img,$img_icon,$img_type,$details,$details_en;
    public $edit_object;
    public $edit_id;
    protected $listeners=[
    ...
    public function mount()
    {
        ...
        if($this->edit_id > 0)
        {
            $this->edit_object= ArtMin::where('deleted_at',null)->find($this->edit_id);
        }
        else
        {
    ...
    public function render()
    {
        ...
        return view('livewire.admin.art-mins.edit',[
    ...
    public function get_object($edit_object)
    {
        ...
        $this->img_type= $this->type =='briefs' ? 'icon':'';
