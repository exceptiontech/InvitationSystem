...
namespace App\Http\Livewire\Admin\Advertisings;
...
{
    use WithFileUploads;
    public $ord,$type,$with_id,$name,$name_en,$img,$img_thumbnail,$url_l,$google_adv,$v_in_home,$v_in_slide,$v_in_app;
    public $edit_object;
    public $edit_id;
    protected $listeners=[
    ...
    public function render()
    {
        ...
        return view('livewire.admin.advertisings.edit',[
