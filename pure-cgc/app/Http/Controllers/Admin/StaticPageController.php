...
class StaticPageController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('admin.static_pages.index',compact('results'));
    }
    ...
    public function create()
    {
        ...
        return view('admin.static_pages.edit',compact('result'));
    }
    ...
    public function edit($id)
    {
        ...
        return view('admin.static_pages.edit',compact('result','title_page','script_editor'));
    }
