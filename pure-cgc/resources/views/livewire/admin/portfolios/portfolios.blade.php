...
@if ($showForm == true)
        <livewire:admin.portfolios.edit />
@elseif ($showDeleted == true)
        <livewire:admin.portfolios.deleted />
@else
...
?>
                <tr>
                    ...
                    <td><img src="{{ img_chk_exist($result->img) }}" style="width: 70px; height: 60px;border-raidus:15px" /></td>
                    <td><img src="{{ img_chk_exist($result->logo) }}" style="width: 70px; height: 60px;border-raidus:15px" /></td>
