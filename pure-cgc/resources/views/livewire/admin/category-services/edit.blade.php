    ...
    <div class="card-body col-md-8 offset-2">
        ...
        <div class="form-group row">
            ...
            <div class="form-group col-6">
                ...
                {!! Form::text('name_en', '', ['wire:model.lazy'=>'name_en','class'=>"form-control"]) !!}            </div>
            {{-- <div class="form-group col-md-6">
                {!! Form::label('logo', __('ms_lang.logo'), []) !!}
                {!! Form::file('logo', '', ['wire:model.lazy'=>'logo','class'=>"form-control"]) !!}
            </div> --}}
            <div class="form-group col-12">
                {!! Form::label('url', __('ms_lang.url_link_t'), []) !!}
                <input type="text" name="url" wire:model.lazy="url" class="form-control" />
            </div>
            <div class="form-group col-md-6">
