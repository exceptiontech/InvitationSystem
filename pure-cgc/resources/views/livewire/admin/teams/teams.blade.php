          ...
          <table class="table table-bordered table-hover table-checkable" id="kt_datatable" style="margin-top: 13px !important">
            <thead>
              <tr>
                ...
                <th>{{ trans('ms_lang.details_en_t') }}</th>
                <th>{{ trans('ms_lang.Specialization_t') }}</th>
                <th>{{ trans('ms_lang.Specialization_en_t') }}</th>
                <th>{{ trans('ms_lang.twitter_url') }}</th>
                <th>{{ trans('ms_lang.facebook_url') }}</th>
                <th>{{ trans('ms_lang.linkedin_url') }}</th>
                <th>{{ trans('ms_lang.instagram_url') }}</th>
...
?>
                <tr>
                    ...
                    <td>{{ $result->Specialization_en }}</td>
