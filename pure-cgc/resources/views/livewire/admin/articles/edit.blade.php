...
@endisset
        ...
        <div class="form-group row">
            ...
            <div class="form-group col-md-6">
                {!! Form::label('auther', __('ms_lang.auther'), []) !!}
                {!! Form::text('auther', '', ['wire:model.lazy'=>'auther','class'=>"form-control"]) !!}
            </div>
...
@if (count($categories))
    ...
    @endforeach
@endif
            <div class="form-group col-md-6  {{ $dis_cat }}">
            ...
            <div class="form-group col-md-10 {{ $dis_img }}">
                ...
                @else
                    {!! Form::file('img', ['wire:model'=>'img','class'=>"form-control"]) !!}
                    {!! Form::hidden('img_type', '', ['wire:model.defer'=>'img_type']) !!}
                @endif
            </div>
