<script type="text/javascript">
	...
	$(document).ready(function()
	{
			...
			$(".request_ajax_ms3").change(function(){
					var json = { "_token": "{{ csrf_token() }}", "ajax_id" : this.value};
					$.ajax({
							url: url,
							dataType: 'json',
							...
							success: function(data, textStatus, XMLHttpRequest)
							{
									$(".response_ajax_ms3").html(data.something);
									$("#response_ajax_ms33").fadeOut();
							},
							error: function(XMLHttpRequest, textStatus, errorThrown)
							{
									// Error Message
									$("#response_ajax_ms33").html( XMLHttpRequest.status + 'Error connecting to:' + XMLHttpRequest.statusText);
							}
					});
					// Loading message
					$("#response_ajax_ms33").html('<span style="color:red">loading...</span>');
			});
