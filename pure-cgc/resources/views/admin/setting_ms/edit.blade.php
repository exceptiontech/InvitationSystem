...
@endif
                ...
                <div class="form-group row">
                    ...
                    <div class="form-group col-md-3">
                        <label for="mobile">whatsapp/ واتساب</label>
                ...
                <div class="form-group row">
                    ...
                    <div class="form-group col-md-12">
                        ...
                        <input type="text" name="keywords" value="{{ @$edit_object_seo->keywords }}" dir="ltr" class="form-control"   />
                    </div>
                    <div class="form-group col-md-12">
                        {!! Form::label('name_en',__('ms_lang.keywords_en'), []) !!}
                        <input type="text" name="keywords_en" value="{{ @$edit_object_seo->keywords_en }}"  class="form-control"   />
                    </div>
                    <div class="form-group col-md-12 ">
                        {!! Form::label('details', __('ms_lang.details_t'), []) !!}
                        <textarea name="details_seo" class="form-control textarea_ms"  placeholder="address" dir='rtl'>{!! @$edit_object_seo->description !!}</textarea>
                    </div>
                    <div class="form-group col-md-12 ">
                        <label for="details_en"> </label>
                        {!! Form::label('details_en', __('ms_lang.details_en_t'), []) !!}
                        <textarea name="details_en_seo" class="form-control textarea_ms"  placeholder="address">{!! @$edit_object_seo->description_en !!}</textarea>
                    </div>
                </div>
