...
<body data-typography="poppins" data-theme-version="light" data-layout="vertical" data-nav-headerbg="color_3"
    data-headerbg="color_1" data-sidebar-style="full" data-sidebarbg="color_3" data-sidebar-position="fixed"
    data-header-position="fixed" data-container="wide" direction="ltr" data-primary="color_1"
    data-sidebartext="color_1">
    ...
    {{-- <div id="main-wrapper"> --}}
                                ...
                                <ul class="contacts">
                                    ...
                                    <li class="active dz-chat-user">
                                        <div class="d-flex bd-highlight">
                                            <div class="img_cont">
                                                <img src="images/pic1.jpg" class="rounded-lg rounded-circle user_img"
                                                    alt="">
        ...
        ***********************************-->
        ...
        $pages_p = $user->getAllPermissions();
        ?>  --}}
                        ...
                        <ul class="navbar-nav header-right">
                            ...
                            <li class="nav-item dropdown notification_dropdown">
                                ...
                                <div class="dropdown-menu dropdown-menu-end">
                                    <div id="DZ_W_Notification1" class="p-2 widget-media dz-scroll">
                                        <ul class="timeline">
                            ...
                            <li class="nav-item dropdown header-profile">
                                <a class="nav-link" href="javascript:void(0);" role="button" data-bs-toggle="dropdown">
                                    <img src="{{ img_chk_exist('images/pic1.jpg') }}" width="20" alt="">
