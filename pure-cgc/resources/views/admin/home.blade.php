...
@section('content')
			<div class="row">
<?php  use App\Models\Admin\User; ?>
@if(in_array('Admin MemberShip', User::find(Auth::id())->getRoleNames()->toArray()))
				<div class="col-xl-2">
					<!--begin::Stats Widget 29-->
					<div class="card card-custom bgi-no-repeat card-stretch gutter-b" style="background-position: right top; background-size: 30% auto; background-color: yellow">
						<!--begin::Body-->
						<div class="card-body">
							...
							<span class="font-weight-bold text-muted font-size-sm">ماركات السيارات</span>
						</div>
						<!--end::Body-->
					</div>
					<!--end::Stats Widget 29-->
					...
					<div class="card card-custom bg-danger card-stretch gutter-b">
						...
						<div class="card-body">
							...
							<span class="card-title font-weight-bolder text-white font-size-h2 mb-0 mt-6 d-block">
                                {{ $cars_models }}</span>
							<span class="font-weight-bold text-white font-size-sm">موديلات السيارات</span>
						</div>
						<!--end::Body-->
					</div>
					<!--end::Stats Widget 31-->
                ...
                <div class="col-xl-2">
					<!--begin::Stats Widget 30-->
					<div class="card card-custom  card-stretch gutter-b" style="background-position: right top; background-size: 30% auto; background-color: rgb(255, 0, 64)">
						<!--begin::Body-->
						<div class="card-body">
							<span class="svg-icon svg-icon-2x svg-icon-white">
								<!--begin::Svg Icon | path:assets/media/svg/icons/Communication/Group.svg-->
				...
				<div class="col-xl-2">
					<!--begin::Stats Widget 30-->
					<div class="card card-custom  card-stretch gutter-b" style="background-position: right top; background-size: 30% auto; background-color: rgb(255, 196, 0)">
						<!--begin::Body-->
						<div class="card-body">
							<span class="svg-icon svg-icon-2x svg-icon-white">
								<!--begin::Svg Icon | path:assets/media/svg/icons/Communication/Group.svg-->
